...
const SubjectOfSubmission = ({ archiveSubjects, subject }: Props) => {
  ...
  return (
    <>
      <Section>
        <TextField
          label={t("components.submission.otherDocumentation.label")}
          description={t("components.submission.otherDocumentation.description")}
      ...
      { !subject &&
        <Section>
          <Select
            label={t("components.submission.subject.label")}
            size="medium"
